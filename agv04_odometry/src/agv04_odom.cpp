...
int main(int argc, char** argv){
  ...
  ros::Subscriber subVx = n.subscribe("agv04/LinearX", 100, VelocityX_Callback);
  ros::Subscriber subVy = n.subscribe("agv04/LinearY", 100, VelocityY_Callback);
  ros::Subscriber subVz = n.subscribe("agv04/AngularZ", 100, VelocityZ_Callback);
