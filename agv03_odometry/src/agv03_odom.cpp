...
int main(int argc, char** argv){
  ...
  ros::Subscriber subVx = n.subscribe("agv03/LinearX", 100, VelocityX_Callback);
  ros::Subscriber subVy = n.subscribe("agv03/LinearY", 100, VelocityY_Callback);
  ros::Subscriber subVz = n.subscribe("agv03/AngularZ", 100, VelocityZ_Callback);
